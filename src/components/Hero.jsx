  ...
  return (
    <Container className="pb-16 pt-20 text-center lg:pt-32">
      ...
      <p className="mx-auto mt-6 max-w-2xl text-lg tracking-tight text-slate-700">
        We offer the highest quality of operator assisted services in the industry!
      </p>
      ...
      <div className="mt-36 lg:mt-44">
        ...
        >
          {[
            [
              { name: 'Evergreenmarketing', logo: logoEvergreenmarketing },
              { name: 'JPM', logo: logoJPM },
              { name: 'Silvon', logo: logoSilvon },
            ],
            [
